...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "hello@airpods3d.com",
      link: "mailto:hello@airpods3d.com"
    },
    {
      icon: Phone,
      title: "Phone",
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-purple-900 via-pink-900 to-red-900 relative overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Ready to experience AirPods Pro in 3D? Contact us for more information, support, or to place your order.
          </motion.p>
        </motion.div>
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-gradient-to-r from-pink-500 to-red-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-pink-600 hover:to-red-700 transition-all duration-200 flex items-center justify-center space-x-2"
                >
                  <Send size={20} />
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    className="flex items-center space-x-4 p-4 glass rounded-xl hover:bg-white/20 transition-all duration-200"
                  >
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 bg-gradient-to-r from-pink-500 to-red-600 rounded-full flex items-center justify-center hover:from-pink-600 hover:to-red-700 transition-all duration-200"
                    title={social.label}
                  >
